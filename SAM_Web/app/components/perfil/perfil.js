...
Perfil.propTypes = {
  ...
  mostraTudo: React.PropTypes.func.isRequired,
  ultimoAno: React.PropTypes.func.isRequired,
  consultaAtividades: React.PropTypes.string.isRequired,
  handlePesquisaAtividades: React.PropTypes.func.isRequired,
  atividades: React.PropTypes.arrayOf(React.PropTypes.element).isRequired,
  consultaPromocoes: React.PropTypes.string.isRequired,
  handlePesquisaPromocoes: React.PropTypes.func.isRequired,
  promocoes: React.PropTypes.arrayOf(React.PropTypes.element).isRequired,
