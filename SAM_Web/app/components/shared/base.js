          ...
          <div className="navbar-fixed">
            <nav className="nav-wrapper color-default row">
              <div className="col s10 offset-s1">
                <Link to={"/Dashboard/" + props.samaccount} className="brand-logo"><img src="./app/imagens/logo-sam.png" style={{height:60}} /></Link>
                <a data-activates="slide-out" className="button-collapse"><i className="material-icons">menu</i></a>
                <ul className="right hide-on-med-and-down">
                  <li><Link to={this.url} className="dropdown-button"
                   data-activates={this.menuUsuario}>Olá, {this.menuUsuario}</Link></li></ul>
              ...
              <ItensMenu itensMenu = {itensMenu} usuario={this.menuUsuario} imagemUsuario={this.imagemUsuario} urlUsuario = {this.url} dropdowns={props.dropdowns}/>
              </div>
            </nav>
          </div>
        </header>
