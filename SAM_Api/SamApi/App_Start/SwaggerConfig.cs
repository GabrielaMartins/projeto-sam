...
namespace SamApi
{
    ...
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "SAM API Documentation");
                        ...
                        //
                        c.IncludeXmlComments(GetSamApiXmlCommentsPath());
                        c.IncludeXmlComments(GetSamApiModelsXmlCommentsPath());
        ...
        {
            return string.Format(@"{0}\bin\SamApi.xml", AppDomain.CurrentDomain.BaseDirectory);
        }
